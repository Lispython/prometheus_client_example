...
tank:
	@echo "Tank load"
	docker run --rm --net prometheusclientexample_default --link dev_prometheustest_flask_app:dev_flask_app -v $(current_dir)/loadtest/:/var/loadtest/ direvius/yandex-tank
